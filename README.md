...
- [orb](https://github.com/vicentereig/orb) - Orb billing forensics from the terminal
...
- [a2ui-rails](https://github.com/vicentereig/a2ui-rails) - Rails port of Google's A2UI using DSPy.rb and Turbo Streams
